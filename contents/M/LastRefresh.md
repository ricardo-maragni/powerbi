# LastRefresh
Código para visualizar a útlima vez que a base de dados do Power Query foi atualizada.
...
## LastRefresh -3h
Caso durante a publicação do Power BI ocorra o erro de somar automaticamente 3h no valor exibido, utilize o código abaixo que já faz a subtração dessas 3h, trazendo o valor real.

```M
let
    Fonte = DateTime.LocalNow()-#duration(0,3,0,0),
    #"Convertido para Tabela" = #table(1, {{Fonte}}),
    #"Tipo Alterado" = Table.TransformColumnTypes(#"Convertido para Tabela",{{"Column1", type datetime}}),
    #"Coluna Duplicada" = Table.DuplicateColumn(#"Tipo Alterado", "Column1", "Column1 - Copiar"),
    #"Coluna Duplicada1" = Table.DuplicateColumn(#"Coluna Duplicada", "Column1 - Copiar", "Column1 - Copiar - Copiar"),
